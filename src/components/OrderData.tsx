...
const OrderData = () => {
  ...
  const dataCategories = [
    ...
    { id: 'salaried', name: 'Salaried Person', price: 0.12 },
    { id: 'self-employed', name: 'Self Employed', price: 0.12 },
    ...
    { id: 'business-loan', name: 'Business Loan Sales', price: 0.12 },
    { id: 'motor-insurance', name: 'Motor Insurance', price: 1.00 },
    { id: 'health-insurance', name: 'Health Insurance Sales', price: 0.12 },
    { id: 'life-insurance', name: 'Life Insurance Sales', price: 0.12 },
    { id: 'general-insurance', name: 'General Insurance Sales', price: 0.12 },
    { id: 'corporate', name: 'Corporate Companies', price: 0.12 },
    { id: 'manufacturing', name: 'Manufacturing Companies', price: 0.12 },
    { id: 'private-limited', name: 'Private Limited Company', price: 0.12 },
    { id: 'msme', name: 'MSME Company', price: 0.12 },
    { id: 'it-company', name: 'IT Company', price: 0.12 },
    { id: 'stock-market', name: 'Stock Market', price: 2.00 },
    { id: 'real-estate', name: 'Real Estate', price: 0.12 },
    { id: 'doctor', name: 'Doctor', price: 0.12 },
    { id: 'local-public', name: 'Local Public', price: 0.12 },
    { id: 'mobile-holder', name: 'Mobile Number Holder', price: 0.12 },
    { id: 'b2b', name: 'B2B Database', price: 0.12 },
    { id: 'b2c', name: 'B2C Database', price: 0.12 },
    { id: 'it-employees', name: 'IT Employees', price: 0.12 },
    { id: 'private-employee', name: 'Private Employee', price: 0.12 },
    { id: 'small-company', name: 'Small Company', price: 0.12 },
    { id: 'small-business', name: 'Small Business', price: 0.12 },
    { id: 'residential', name: 'Residential', price: 0.12 },
  ...
  const initiatePayment = () => {
    ...
    script.onload = () => {
      const options = {
        key: 'rzp_live_XH95alJE6lzsoF', // Replace with your Razorpay key
