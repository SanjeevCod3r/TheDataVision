          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <p className="text-gray-300">support@thedatavision.com</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              2024 THE DATA VISION. All rights reserved.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-4 md:mt-0">
              <a 
                ...
                className="text-gray-400 hover:text-white text-sm transition-colors whitespace-nowrap cursor-pointer"
              >
                Privacy Policy
              </a>
              <a 
                href="/terms-of-conditions" 
                onClick={(e) => handleNavigation(e, 'terms-of-conditions')}
                className="text-gray-400 hover:text-white text-sm transition-colors whitespace-nowrap cursor-pointer"
              >
                Terms of Conditions
              </a>
              <a 
                ...
                onClick={(e) => handleNavigation(e, 'cancellation-and-refunds')}
                className="text-gray-400 hover:text-white text-sm transition-colors whitespace-nowrap cursor-pointer"
              >
              ...
              <a 
                ...
                onClick={(e) => handleNavigation(e, 'shipping-policy')}
                className="text-gray-400 hover:text-white text-sm transition-colors whitespace-nowrap cursor-pointer"
              >
                Shipping Policy
              </a>
